...
\title{Network and Cloud Infrastructures Project Work - SDN Network Slicing with Ryu and Mininet}
\author{Davide Di Matteo - M63001865 \\ \texttt{dav.dimatteo@studenti.unina.it}}
\date{Università degli studi di Napoli Federico II --- \today}
...
\input{sections/0_introduzione.tex}

\section{Topology slicing}
\input{sections/1_topology_slicing.tex}

\section{Service slicing}
\input{sections/2_service_slicing.tex}
